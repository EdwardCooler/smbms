...
import com.zr.service.role.RoleService;
import com.zr.service.role.RoleServiceImpl;
import com.zr.service.user.UserService;
import com.zr.service.user.UserServiceImpl;
import com.zr.util.Constants;
import com.zr.util.PageSupport;
...
public class UserServlet extends HttpServlet {
    ...
    private void getPwdByUserId(HttpServletRequest request, HttpServletResponse response)
        ...
        // 前端设置的接收数据类型datatype为json，即需要将map转换为json
